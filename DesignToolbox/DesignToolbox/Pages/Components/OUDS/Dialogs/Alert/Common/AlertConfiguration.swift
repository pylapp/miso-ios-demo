...
open class AlertConfigurationModel: ComponentConfiguration {
    ...
    @MainActor
    func status(from theme: MISOTheme) -> MISOAlertStatus {
        ...
        case .neutral:
            .neutral(image: statusIcon == .none ? nil : MISOImage(asset: imageAsset, flipped: flipIcon, renderingMode: imageRenderingMode))
        case .accent:
            .accent(image: statusIcon == .none ? nil : MISOImage(asset: imageAsset, flipped: flipIcon, renderingMode: imageRenderingMode))
        case .positive:
            .positive
        case .info:
            .info
    ...
    var iconPattern: String {
        ...
        case .neutral, .accent:
            ...
            case .none:
                ""
            case .tintedIcon:
                "image: MISOImage(asset: Image(decorative: \"tips-and-tricks\")\(flipIconPattern)\(renderingModePattern))"
            case .image:
