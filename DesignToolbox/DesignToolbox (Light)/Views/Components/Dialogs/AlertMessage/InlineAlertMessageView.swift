...
struct InlineAlertMessageView: View {
    ...
    private var watchVerticalLayout: some View {
        WatchVerticalLayout {
            ...
            OUDSInlineAlert(label: "This is also a neutral alert", status: .neutral(icon: OUDSIcon(asset: Image(systemName: "figure.handball"))))
            OUDSInlineAlert(label: "This is an accent alert", status: .accent())
            OUDSInlineAlert(label: "This is also a accent alert", status: .neutral(icon: OUDSIcon(asset: Image(systemName: "figure.handball"))))
