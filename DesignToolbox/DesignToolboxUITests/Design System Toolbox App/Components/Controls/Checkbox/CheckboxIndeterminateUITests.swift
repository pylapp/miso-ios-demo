...
/// To make UI tests on `OUDSCheckboxIndeterminate` to test some a11y configurations.
final class CheckboxIndeterminateUITests: AppTestCase {
    ...
    @MainActor func testCheckboxIndeterminateA11yConfigurations() throws {
        ...
        tapLink(withWording: "app_components_checkbox_indeterminateCheckbox_tech", app)
