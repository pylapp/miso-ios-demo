...
final class RadioItemUITests: AppTestCase {
    ...
    @MainActor func testRadioItemA11yConfigurations() throws {
        ...
        check(value: "core_common_selected_a11y", ofElementWithIdentifier: A11YIdentifiers.componentRadioItem, app)
        ...
        check(value: "core_common_unselected_a11y", ofElementWithIdentifier: A11YIdentifiers.componentRadioItem, app)
