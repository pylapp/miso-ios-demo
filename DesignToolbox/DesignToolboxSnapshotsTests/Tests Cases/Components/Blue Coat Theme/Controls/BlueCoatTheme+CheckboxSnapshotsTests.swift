...
/// is in the management of the states. Uses `BlueCoatTheme`.
final class BlueCoatThemeCheckboxSnapshotsTests: CheckboxSnapshotsTestsTestCase {
    ...
    @MainActor func testAllCheckboxesBlueCoatThemeLight() {
    ...
    @MainActor func testAllCheckboxesBlueCoatThemeDark() {
